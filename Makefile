...
.PHONY: generate-v1beta1-client
 generate-v1beta1-client:
	...
	@echo "==> Generating billing client"
	swagger generate client -f pkg/tidbcloud/v1beta1/billing/billing.swagger.json -A tidbcloud -t pkg/tidbcloud/v1beta1/billing
