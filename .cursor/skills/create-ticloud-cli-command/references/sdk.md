...
4. Run `make generate-mocks` to refresh mocks. Do not edit mock files by hand; they must be auto-generated by this command. If `make generate-mocks` runs failed, ask user to run it. Do not continue before this command success unless user ask to skip!