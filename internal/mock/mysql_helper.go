...
func (_m *MySQLHelper) DumpFromMySQL(ctx context.Context, arg string) error {
	ret := _m.Called(arg)
...
func (_m *MySQLHelper) ImportToServerless(ctx context.Context, sqlCacheFile string, connectionString string) error {
