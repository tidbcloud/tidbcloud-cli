...
// DownloadExportFiles provides a mock function with given fields: params, opts
func (_m *TiDBCloudClient) DownloadExportFiles(params *export_service.ExportServiceDownloadExportFilesParams, opts ...export_service.ClientOption) (*export_service.ExportServiceDownloadExportFilesOK, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *export_service.ExportServiceDownloadExportFilesOK
	var r1 error
	if rf, ok := ret.Get(0).(func(*export_service.ExportServiceDownloadExportFilesParams, ...export_service.ClientOption) (*export_service.ExportServiceDownloadExportFilesOK, error)); ok {
		return rf(params, opts...)
	}
	if rf, ok := ret.Get(0).(func(*export_service.ExportServiceDownloadExportFilesParams, ...export_service.ClientOption) *export_service.ExportServiceDownloadExportFilesOK); ok {
		r0 = rf(params, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*export_service.ExportServiceDownloadExportFilesOK)
		}
	}

	if rf, ok := ret.Get(1).(func(*export_service.ExportServiceDownloadExportFilesParams, ...export_service.ClientOption) error); ok {
		r1 = rf(params, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// ListExportFiles provides a mock function with given fields: params, opts
func (_m *TiDBCloudClient) ListExportFiles(params *export_service.ExportServiceListExportFilesParams, opts ...export_service.ClientOption) (*export_service.ExportServiceListExportFilesOK, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *export_service.ExportServiceListExportFilesOK
	var r1 error
	if rf, ok := ret.Get(0).(func(*export_service.ExportServiceListExportFilesParams, ...export_service.ClientOption) (*export_service.ExportServiceListExportFilesOK, error)); ok {
		return rf(params, opts...)
	}
	if rf, ok := ret.Get(0).(func(*export_service.ExportServiceListExportFilesParams, ...export_service.ClientOption) *export_service.ExportServiceListExportFilesOK); ok {
		r0 = rf(params, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*export_service.ExportServiceListExportFilesOK)
		}
	}

	if rf, ok := ret.Get(1).(func(*export_service.ExportServiceListExportFilesParams, ...export_service.ClientOption) error); ok {
		r1 = rf(params, opts...)
	} else {
		r1 = ret.Error(1)
	}
