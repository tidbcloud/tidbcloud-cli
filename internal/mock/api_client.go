...
// GetAvailabilityZones provides a mock function with given fields: ctx, clusterId
func (_m *TiDBCloudClient) GetAvailabilityZones(ctx context.Context, clusterId string) (*privatelink.GetAvailabilityZonesResponse, error) {
	ret := _m.Called(ctx, clusterId)

	if len(ret) == 0 {
		panic("no return value specified for GetAvailabilityZones")
	}
