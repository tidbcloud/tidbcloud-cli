...
import (
	...
	openapi "tidbcloud-cli/pkg/tidbcloud/v1beta1/serverless/iam"
...
func (_m *TiDBCloudClient) ListProjects(ctx context.Context, pageSize *int32, pageToken *string) (*openapi.ApiListProjectsRsp, error) {
	...
	var r0 *openapi.ApiListProjectsRsp
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *int32, *string) (*openapi.ApiListProjectsRsp, error)); ok {
		return rf(ctx, pageSize, pageToken)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *int32, *string) *openapi.ApiListProjectsRsp); ok {
		r0 = rf(ctx, pageSize, pageToken)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*openapi.ApiListProjectsRsp)
		}
	}
