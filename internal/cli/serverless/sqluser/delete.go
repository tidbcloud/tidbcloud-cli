...
// 			if !force {
// 				if !h.IOStreams.CanPrompt {
// 					return fmt.Errorf("the terminal doesn't support prompt, please run with --force to delete the SQL user")
// 				}
...
// 					return errors.New("incorrect confirm string entered, skipping SQL user deletion")
// 				}
// 			}
