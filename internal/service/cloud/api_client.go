...
type TiDBCloudClient interface {
	...
	// Serverless Private Link Connection methods
	...
	GetAvailabilityZones(ctx context.Context, clusterId string) (*privatelink.GetAvailabilityZonesResponse, error)
}
...
func (d *ClientDelegate) GetAvailabilityZones(ctx context.Context, clusterId string) (*privatelink.GetAvailabilityZonesResponse, error) {
