...
const (
	...
	PrivateLinkServiceName     string = "private-link-service-name"
	...
	EndpointServiceName        string = "endpoint-service-name"
	EndpointServiceRegion      string = "endpoint-service-region"
