...
func (o *MigrationServiceCreateMigrationBody) GetShardMode() TaskShardMode {
...
// and a boolean to check if the value has been set.
func (o *MigrationServiceCreateMigrationBody) GetShardModeOk() (*TaskShardMode, bool) {
	if o == nil || IsNil(o.ShardMode) {
		return nil, false
	}
...
func (o *MigrationServiceCreateMigrationBody) HasShardMode() bool {
	if o != nil && !IsNil(o.ShardMode) {
		return true
	}
...
func (o *MigrationServiceCreateMigrationBody) SetShardMode(v TaskShardMode) {
	o.ShardMode = &v
}
