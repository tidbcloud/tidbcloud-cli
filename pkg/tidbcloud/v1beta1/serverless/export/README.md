...
------------ | ------------- | ------------- | -------------
*ExportAPI* | [**ExportServiceCancelExport**](docs/ExportAPI.md#exportservicecancelexport) | **Post** /v1beta1/clusters/{clusterId}/exports/{exportId}:cancel | Cancel an export task
*ExportAPI* | [**ExportServiceCreateExport**](docs/ExportAPI.md#exportservicecreateexport) | **Post** /v1beta1/clusters/{clusterId}/exports | Create an export task
*ExportAPI* | [**ExportServiceDeleteExport**](docs/ExportAPI.md#exportservicedeleteexport) | **Delete** /v1beta1/clusters/{clusterId}/exports/{exportId} | Delete an export task
*ExportAPI* | [**ExportServiceGetExport**](docs/ExportAPI.md#exportservicegetexport) | **Get** /v1beta1/clusters/{clusterId}/exports/{exportId} | Get details of an export task
*ExportAPI* | [**ExportServiceListExports**](docs/ExportAPI.md#exportservicelistexports) | **Get** /v1beta1/clusters/{clusterId}/exports | List export tasks on a cluster
