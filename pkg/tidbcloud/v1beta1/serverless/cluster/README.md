...
------------ | ------------- | ------------- | -------------
*ClusterServiceAPI* | [**ClusterServiceBatchCreateClusters**](docs/ClusterServiceAPI.md#clusterservicebatchcreateclusters) | **Post** /clusters:batchCreate | Creates new TiDB Cloud Starter and Essential clusters in batch
*ClusterServiceAPI* | [**ClusterServiceBatchGetClusters**](docs/ClusterServiceAPI.md#clusterservicebatchgetclusters) | **Get** /clusters:batchGet | Retrieves details of TiDB Cloud Starter and Essential clusters in batch
*ClusterServiceAPI* | [**ClusterServiceChangeRootPassword**](docs/ClusterServiceAPI.md#clusterservicechangerootpassword) | **Put** /clusters/{clusterId}/password | Changes the root password of a specific TiDB Cloud Serverless cluster
*ClusterServiceAPI* | [**ClusterServiceCreateCluster**](docs/ClusterServiceAPI.md#clusterservicecreatecluster) | **Post** /clusters | Create a new TiDB Cloud Starter or Essential cluster
*ClusterServiceAPI* | [**ClusterServiceDeleteCluster**](docs/ClusterServiceAPI.md#clusterservicedeletecluster) | **Delete** /clusters/{clusterId} | Delete a TiDB Cloud Starter or Essential cluster
*ClusterServiceAPI* | [**ClusterServiceGetCluster**](docs/ClusterServiceAPI.md#clusterservicegetcluster) | **Get** /clusters/{clusterId} | Get details of a TiDB Cloud Starter or Essential cluster
*ClusterServiceAPI* | [**ClusterServiceListCloudProviders**](docs/ClusterServiceAPI.md#clusterservicelistcloudproviders) | **Get** /regions:listCloudProviders | List available cloud providers for an organization
*ClusterServiceAPI* | [**ClusterServiceListClusters**](docs/ClusterServiceAPI.md#clusterservicelistclusters) | **Get** /clusters | List TiDB Cloud Starter and Essential clusters
*ClusterServiceAPI* | [**ClusterServiceListRegions**](docs/ClusterServiceAPI.md#clusterservicelistregions) | **Get** /regions | List available regions for an organization
*ClusterServiceAPI* | [**ClusterServicePartialUpdateCluster**](docs/ClusterServiceAPI.md#clusterservicepartialupdatecluster) | **Patch** /clusters/{cluster.clusterId} | Update a TiDB Cloud Starter or Essential cluster


## Documentation For Models

 - [ClusterClusterPlan](docs/ClusterClusterPlan.md)
 - [ClusterServiceChangeRootPasswordBody](docs/ClusterServiceChangeRootPasswordBody.md)
 - [ClusterServiceGetClusterViewParameter](docs/ClusterServiceGetClusterViewParameter.md)
 - [ClusterServiceListRegionsServicePlanParameter](docs/ClusterServiceListRegionsServicePlanParameter.md)
 ...
 - [PrivateALICLOUD](docs/PrivateALICLOUD.md)
 - [PrivateAWS](docs/PrivateAWS.md)
 - [PrivateGCP](docs/PrivateGCP.md)
 - [ProtobufAny](docs/ProtobufAny.md)
 - [Serverlessv1beta1ClusterHighAvailabilityType](docs/Serverlessv1beta1ClusterHighAvailabilityType.md)
 - [Serverlessv1beta1ClusterView](docs/Serverlessv1beta1ClusterView.md)
 - [Serverlessv1beta1ListCloudProvidersResponse](docs/Serverlessv1beta1ListCloudProvidersResponse.md)
 ...
 - [V1beta1ClusterServicePartialUpdateClusterBody](docs/V1beta1ClusterServicePartialUpdateClusterBody.md)
 - [V1beta1ClusterServicePartialUpdateClusterBodyCluster](docs/V1beta1ClusterServicePartialUpdateClusterBodyCluster.md)
