...
const (
	...
	// CreateImportReqImportTypeGCS captures enum value "GCS"
	CreateImportReqImportTypeGCS CreateImportReqImportType = "GCS"
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["S3","GCS","LOCAL"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
