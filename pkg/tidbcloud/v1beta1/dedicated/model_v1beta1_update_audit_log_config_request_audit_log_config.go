...
func (o *V1beta1UpdateAuditLogConfigRequestAuditLogConfig) GetBucketManager() AuditLogConfigBucketManager {
...
// and a boolean to check if the value has been set.
func (o *V1beta1UpdateAuditLogConfigRequestAuditLogConfig) GetBucketManagerOk() (*AuditLogConfigBucketManager, bool) {
	if o == nil || IsNil(o.BucketManager) {
		return nil, false
	}
...
func (o *V1beta1UpdateAuditLogConfigRequestAuditLogConfig) SetBucketManager(v AuditLogConfigBucketManager) {
	o.BucketManager = &v
}

// GetUnredacted returns the Unredacted field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *V1beta1UpdateAuditLogConfigRequestAuditLogConfig) GetUnredacted() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *V1beta1UpdateAuditLogConfigRequestAuditLogConfig) GetUnredactedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *V1beta1UpdateAuditLogConfigRequestAuditLogConfig) HasUnredacted() bool {
...
func (o *V1beta1UpdateAuditLogConfigRequestAuditLogConfig) SetUnredacted(v bool) {
	o.Unredacted.Set(&v)
}

// SetUnredactedNil sets the value for Unredacted to be an explicit nil
func (o *V1beta1UpdateAuditLogConfigRequestAuditLogConfig) SetUnredactedNil() {
	o.Unredacted.Set(nil)
}

// UnsetUnredacted ensures that no value is present for Unredacted, not even an explicit nil
func (o *V1beta1UpdateAuditLogConfigRequestAuditLogConfig) UnsetUnredacted() {
	o.Unredacted.Unset()
}

// GetFormat returns the Format field value if set, zero value otherwise.
func (o *V1beta1UpdateAuditLogConfigRequestAuditLogConfig) GetFormat() V1beta1AuditLogConfigFormat {
...
// and a boolean to check if the value has been set.
func (o *V1beta1UpdateAuditLogConfigRequestAuditLogConfig) GetFormatOk() (*V1beta1AuditLogConfigFormat, bool) {
	if o == nil || IsNil(o.Format) {
		return nil, false
	}
...
func (o *V1beta1UpdateAuditLogConfigRequestAuditLogConfig) HasFormat() bool {
	if o != nil && !IsNil(o.Format) {
		return true
	}
...
func (o *V1beta1UpdateAuditLogConfigRequestAuditLogConfig) SetFormat(v V1beta1AuditLogConfigFormat) {
	o.Format = &v
}

// GetRotationPolicy returns the RotationPolicy field value if set, zero value otherwise.
func (o *V1beta1UpdateAuditLogConfigRequestAuditLogConfig) GetRotationPolicy() V1beta1AuditLogConfigRotationPolicy {
...
// and a boolean to check if the value has been set.
func (o *V1beta1UpdateAuditLogConfigRequestAuditLogConfig) GetRotationPolicyOk() (*V1beta1AuditLogConfigRotationPolicy, bool) {
	if o == nil || IsNil(o.RotationPolicy) {
		return nil, false
	}
...
func (o *V1beta1UpdateAuditLogConfigRequestAuditLogConfig) HasRotationPolicy() bool {
	if o != nil && !IsNil(o.RotationPolicy) {
		return true
	}
...
func (o *V1beta1UpdateAuditLogConfigRequestAuditLogConfig) SetRotationPolicy(v V1beta1AuditLogConfigRotationPolicy) {
	o.RotationPolicy = &v
}
