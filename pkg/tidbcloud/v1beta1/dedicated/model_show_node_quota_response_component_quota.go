...
type ShowNodeQuotaResponseComponentQuota struct {
	// The component type. The value options are:  - `TIDB`: [TiDB node](https://docs.pingcap.com/tidbcloud/tidb-cloud-glossary/#tidb-node).  - `TIKV`: [TiKV node](https://docs.pingcap.com/tidbcloud/tidb-cloud-glossary/#tikv-node).  - `TIFLASH`: [TiFlash node](https://docs.pingcap.com/tidbcloud/tidb-cloud-glossary/#tiflash-node).
	ComponentType *Dedicatedv1beta1ComponentType `json:"componentType,omitempty"`
	// The maximum number of nodes allowed for this component type.
