...
func (o *DatabaseAuditLogServiceCreateAuditLogFilterRuleRequest) GetDisabled() bool {
...
// and a boolean to check if the value has been set.
func (o *DatabaseAuditLogServiceCreateAuditLogFilterRuleRequest) GetDisabledOk() (*bool, bool) {
	if o == nil || IsNil(o.Disabled) {
		return nil, false
	}
...
func (o *DatabaseAuditLogServiceCreateAuditLogFilterRuleRequest) HasDisabled() bool {
	if o != nil && !IsNil(o.Disabled) {
		return true
	}
...
func (o *DatabaseAuditLogServiceCreateAuditLogFilterRuleRequest) SetDisabled(v bool) {
	o.Disabled = &v
}

// GetEventTypes returns the EventTypes field value if set, zero value otherwise.
func (o *DatabaseAuditLogServiceCreateAuditLogFilterRuleRequest) GetEventTypes() []Dedicatedv1beta1AuditLogFilterRuleEventType {
...
// and a boolean to check if the value has been set.
func (o *DatabaseAuditLogServiceCreateAuditLogFilterRuleRequest) GetEventTypesOk() ([]Dedicatedv1beta1AuditLogFilterRuleEventType, bool) {
	if o == nil || IsNil(o.EventTypes) {
		return nil, false
	}
...
func (o *DatabaseAuditLogServiceCreateAuditLogFilterRuleRequest) HasEventTypes() bool {
	if o != nil && !IsNil(o.EventTypes) {
		return true
	}
...
func (o *DatabaseAuditLogServiceCreateAuditLogFilterRuleRequest) SetEventTypes(v []Dedicatedv1beta1AuditLogFilterRuleEventType) {
	o.EventTypes = v
}

// GetDisplayName returns the DisplayName field value if set, zero value otherwise.
func (o *DatabaseAuditLogServiceCreateAuditLogFilterRuleRequest) GetDisplayName() string {
...
// and a boolean to check if the value has been set.
func (o *DatabaseAuditLogServiceCreateAuditLogFilterRuleRequest) GetDisplayNameOk() (*string, bool) {
	if o == nil || IsNil(o.DisplayName) {
		return nil, false
	}
...
func (o *DatabaseAuditLogServiceCreateAuditLogFilterRuleRequest) HasDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
...
func (o *DatabaseAuditLogServiceCreateAuditLogFilterRuleRequest) SetDisplayName(v string) {
	o.DisplayName = &v
}
