...
type V1beta1UpdateClusterRequestTidbNodeSetting struct {
	// The node spec key of the TiDB nodes in the cluster. For example, `8C32G`.   To get the node spec available configurations of a specific region for a cloud provider, please refer to [List node specs](#tag/Cluster/operation/RegionService_ListNodeSpecs) API.
	NodeSpecKey *string `json:"nodeSpecKey,omitempty"`
	// The TiDB node groups of the cluster.
