...
// V1beta1AuditLogConfigFormat the model 'V1beta1AuditLogConfigFormat'
type V1beta1AuditLogConfigFormat string

// List of v1beta1AuditLogConfigFormat
const (
	V1BETA1AUDITLOGCONFIGFORMAT_TEXT V1beta1AuditLogConfigFormat = "TEXT"
	V1BETA1AUDITLOGCONFIGFORMAT_JSON V1beta1AuditLogConfigFormat = "JSON"
)

// All allowed values of V1beta1AuditLogConfigFormat enum
var AllowedV1beta1AuditLogConfigFormatEnumValues = []V1beta1AuditLogConfigFormat{
	"TEXT",
	"JSON",
}

func (v *V1beta1AuditLogConfigFormat) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := V1beta1AuditLogConfigFormat(value)
	for _, existing := range AllowedV1beta1AuditLogConfigFormatEnumValues {
	...
	*v = V1beta1AuditLogConfigFormat(value)
	return nil
}

// NewV1beta1AuditLogConfigFormatFromValue returns a pointer to a valid V1beta1AuditLogConfigFormat for the value passed as argument
func NewV1beta1AuditLogConfigFormatFromValue(v string) *V1beta1AuditLogConfigFormat {
	ev := V1beta1AuditLogConfigFormat(v)
	return &ev
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v V1beta1AuditLogConfigFormat) IsValid() bool {
	for _, existing := range AllowedV1beta1AuditLogConfigFormatEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to v1beta1AuditLogConfigFormat value
func (v V1beta1AuditLogConfigFormat) Ptr() *V1beta1AuditLogConfigFormat {
	return &v
}

type NullableV1beta1AuditLogConfigFormat struct {
	value *V1beta1AuditLogConfigFormat
	isSet bool
}

func (v NullableV1beta1AuditLogConfigFormat) Get() *V1beta1AuditLogConfigFormat {
	return v.value
}

func (v *NullableV1beta1AuditLogConfigFormat) Set(val *V1beta1AuditLogConfigFormat) {
	v.value = val
	v.isSet = true
}

func (v NullableV1beta1AuditLogConfigFormat) IsSet() bool {
	return v.isSet
}

func (v *NullableV1beta1AuditLogConfigFormat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1beta1AuditLogConfigFormat(val *V1beta1AuditLogConfigFormat) *NullableV1beta1AuditLogConfigFormat {
	return &NullableV1beta1AuditLogConfigFormat{value: val, isSet: true}
}

func (v NullableV1beta1AuditLogConfigFormat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1beta1AuditLogConfigFormat) UnmarshalJSON(src []byte) error {
	v.isSet = true
