...
type Dedicatedv1beta1ClusterPausePlan struct {
	// The type of the pause plan.  - `\"NORMAL\"`: the default pause plan. - `\"DEPRECATE\"`: the legacy pause plan and will be removed in a future release.
	PauseType Dedicatedv1beta1ClusterPausePlanType `json:"pauseType"`
	// The scheduled time for the cluster to automatically resume from the `PAUSED` state, in the [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
