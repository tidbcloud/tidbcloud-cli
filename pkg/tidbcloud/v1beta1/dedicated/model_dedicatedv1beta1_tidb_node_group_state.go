...
// Dedicatedv1beta1TidbNodeGroupState  - ACTIVE: Indicates the TiDB group is active and ready for use.  - MODIFYING: Indicates the TiDB group is being modified.  - PAUSED: Indicates the TiDB group is paused.
