...
type Dedicatedv1beta1QueryAuditLogFilesResponse struct {
	AuditLogFiles        []Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile `json:"auditLogFiles,omitempty"`
...
func (o *Dedicatedv1beta1QueryAuditLogFilesResponse) GetAuditLogFiles() []Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile {
	if o == nil || IsNil(o.AuditLogFiles) {
		var ret []Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile
		return ret
	}
...
func (o *Dedicatedv1beta1QueryAuditLogFilesResponse) GetAuditLogFilesOk() ([]Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile, bool) {
	if o == nil || IsNil(o.AuditLogFiles) {
		return nil, false
	}
...
// SetAuditLogFiles gets a reference to the given []Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile and assigns it to the AuditLogFiles field.
func (o *Dedicatedv1beta1QueryAuditLogFilesResponse) SetAuditLogFiles(v []Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) {
	o.AuditLogFiles = v
}
