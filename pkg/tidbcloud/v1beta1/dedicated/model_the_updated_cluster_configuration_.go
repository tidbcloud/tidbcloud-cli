...
// checks if the TheUpdatedClusterConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TheUpdatedClusterConfiguration{}

// TheUpdatedClusterConfiguration struct for TheUpdatedClusterConfiguration
type TheUpdatedClusterConfiguration struct {
	// The TiDB node setting for updating cluster.   To get the node spec available configurations of a specific region for a cloud provider, please refer to [List node specs](#tag/RegionService/operation/RegionService_ListNodeSpecs) API.
	TidbNodeSetting *V1beta1UpdateClusterRequestTidbNodeSetting `json:"tidbNodeSetting,omitempty"`
	// The TiKV node setting for updating cluster.   To get the node spec available configurations of a specific region for a cloud provider, please refer to [List node specs](#tag/RegionService/operation/RegionService_ListNodeSpecs) API.
	TikvNodeSetting *V1beta1UpdateClusterRequestStorageNodeSetting `json:"tikvNodeSetting,omitempty"`
	// The TiFlash node setting for updating cluster.   To get the node spec available configurations of a specific region for a cloud provider, please refer to [List node specs](#tag/RegionService/operation/RegionService_ListNodeSpecs) API.
	TiflashNodeSetting *V1beta1UpdateClusterRequestStorageNodeSetting `json:"tiflashNodeSetting,omitempty"`
	// The display name of the cluster.
	DisplayName *string `json:"displayName,omitempty"`
	// The labels of the cluster.   **Note**: Currently, does not support `labels` updates.
	Labels               *map[string]string `json:"labels,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _TheUpdatedClusterConfiguration TheUpdatedClusterConfiguration

// NewTheUpdatedClusterConfiguration instantiates a new TheUpdatedClusterConfiguration object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTheUpdatedClusterConfiguration() *TheUpdatedClusterConfiguration {
	this := TheUpdatedClusterConfiguration{}
	return &this
}

// NewTheUpdatedClusterConfigurationWithDefaults instantiates a new TheUpdatedClusterConfiguration object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTheUpdatedClusterConfigurationWithDefaults() *TheUpdatedClusterConfiguration {
	this := TheUpdatedClusterConfiguration{}
	return &this
}

// GetTidbNodeSetting returns the TidbNodeSetting field value if set, zero value otherwise.
func (o *TheUpdatedClusterConfiguration) GetTidbNodeSetting() V1beta1UpdateClusterRequestTidbNodeSetting {
...
func (o *TheUpdatedClusterConfiguration) GetTidbNodeSettingOk() (*V1beta1UpdateClusterRequestTidbNodeSetting, bool) {
	if o == nil || IsNil(o.TidbNodeSetting) {
		return nil, false
	}
...
func (o *TheUpdatedClusterConfiguration) HasTidbNodeSetting() bool {
	if o != nil && !IsNil(o.TidbNodeSetting) {
		return true
	}
...
func (o *TheUpdatedClusterConfiguration) SetTidbNodeSetting(v V1beta1UpdateClusterRequestTidbNodeSetting) {
	o.TidbNodeSetting = &v
}

// GetTikvNodeSetting returns the TikvNodeSetting field value if set, zero value otherwise.
func (o *TheUpdatedClusterConfiguration) GetTikvNodeSetting() V1beta1UpdateClusterRequestStorageNodeSetting {
...
// and a boolean to check if the value has been set.
func (o *TheUpdatedClusterConfiguration) GetTikvNodeSettingOk() (*V1beta1UpdateClusterRequestStorageNodeSetting, bool) {
	if o == nil || IsNil(o.TikvNodeSetting) {
		return nil, false
	}
...
func (o *TheUpdatedClusterConfiguration) HasTikvNodeSetting() bool {
	if o != nil && !IsNil(o.TikvNodeSetting) {
		return true
	}
...
func (o *TheUpdatedClusterConfiguration) SetTikvNodeSetting(v V1beta1UpdateClusterRequestStorageNodeSetting) {
	o.TikvNodeSetting = &v
}

// GetTiflashNodeSetting returns the TiflashNodeSetting field value if set, zero value otherwise.
func (o *TheUpdatedClusterConfiguration) GetTiflashNodeSetting() V1beta1UpdateClusterRequestStorageNodeSetting {
...
// and a boolean to check if the value has been set.
func (o *TheUpdatedClusterConfiguration) GetTiflashNodeSettingOk() (*V1beta1UpdateClusterRequestStorageNodeSetting, bool) {
	if o == nil || IsNil(o.TiflashNodeSetting) {
		return nil, false
	}
...
func (o *TheUpdatedClusterConfiguration) HasTiflashNodeSetting() bool {
	if o != nil && !IsNil(o.TiflashNodeSetting) {
		return true
	}
...
func (o *TheUpdatedClusterConfiguration) SetTiflashNodeSetting(v V1beta1UpdateClusterRequestStorageNodeSetting) {
	o.TiflashNodeSetting = &v
}

// GetDisplayName returns the DisplayName field value if set, zero value otherwise.
func (o *TheUpdatedClusterConfiguration) GetDisplayName() string {
...
// and a boolean to check if the value has been set.
func (o *TheUpdatedClusterConfiguration) GetDisplayNameOk() (*string, bool) {
	if o == nil || IsNil(o.DisplayName) {
		return nil, false
	}
...
func (o *TheUpdatedClusterConfiguration) HasDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
...
func (o *TheUpdatedClusterConfiguration) SetDisplayName(v string) {
	o.DisplayName = &v
}

// GetLabels returns the Labels field value if set, zero value otherwise.
func (o *TheUpdatedClusterConfiguration) GetLabels() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *TheUpdatedClusterConfiguration) GetLabelsOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.Labels) {
		return nil, false
	}
...
func (o *TheUpdatedClusterConfiguration) HasLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *TheUpdatedClusterConfiguration) SetLabels(v map[string]string) {
	o.Labels = &v
}

func (o TheUpdatedClusterConfiguration) MarshalJSON() ([]byte, error) {
...
func (o TheUpdatedClusterConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *TheUpdatedClusterConfiguration) UnmarshalJSON(data []byte) (err error) {
	varTheUpdatedClusterConfiguration := _TheUpdatedClusterConfiguration{}

	err = json.Unmarshal(data, &varTheUpdatedClusterConfiguration)

	if err != nil {
		return err
	}

	*o = TheUpdatedClusterConfiguration(varTheUpdatedClusterConfiguration)
...
type NullableTheUpdatedClusterConfiguration struct {
	value *TheUpdatedClusterConfiguration
	isSet bool
}

func (v NullableTheUpdatedClusterConfiguration) Get() *TheUpdatedClusterConfiguration {
	return v.value
}

func (v *NullableTheUpdatedClusterConfiguration) Set(val *TheUpdatedClusterConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableTheUpdatedClusterConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableTheUpdatedClusterConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTheUpdatedClusterConfiguration(val *TheUpdatedClusterConfiguration) *NullableTheUpdatedClusterConfiguration {
	return &NullableTheUpdatedClusterConfiguration{value: val, isSet: true}
}

func (v NullableTheUpdatedClusterConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTheUpdatedClusterConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
