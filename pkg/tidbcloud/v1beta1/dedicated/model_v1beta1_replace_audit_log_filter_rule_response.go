...
// checks if the V1beta1ReplaceAuditLogFilterRuleResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1beta1ReplaceAuditLogFilterRuleResponse{}

// V1beta1ReplaceAuditLogFilterRuleResponse struct for V1beta1ReplaceAuditLogFilterRuleResponse
type V1beta1ReplaceAuditLogFilterRuleResponse struct {
	AuditLogFilterRule   *Dedicatedv1beta1AuditLogFilterRule `json:"auditLogFilterRule,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _V1beta1ReplaceAuditLogFilterRuleResponse V1beta1ReplaceAuditLogFilterRuleResponse

// NewV1beta1ReplaceAuditLogFilterRuleResponse instantiates a new V1beta1ReplaceAuditLogFilterRuleResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewV1beta1ReplaceAuditLogFilterRuleResponse() *V1beta1ReplaceAuditLogFilterRuleResponse {
	this := V1beta1ReplaceAuditLogFilterRuleResponse{}
	return &this
}

// NewV1beta1ReplaceAuditLogFilterRuleResponseWithDefaults instantiates a new V1beta1ReplaceAuditLogFilterRuleResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewV1beta1ReplaceAuditLogFilterRuleResponseWithDefaults() *V1beta1ReplaceAuditLogFilterRuleResponse {
	this := V1beta1ReplaceAuditLogFilterRuleResponse{}
	return &this
}

// GetAuditLogFilterRule returns the AuditLogFilterRule field value if set, zero value otherwise.
func (o *V1beta1ReplaceAuditLogFilterRuleResponse) GetAuditLogFilterRule() Dedicatedv1beta1AuditLogFilterRule {
	if o == nil || IsNil(o.AuditLogFilterRule) {
		var ret Dedicatedv1beta1AuditLogFilterRule
		return ret
	}
	return *o.AuditLogFilterRule
}

// GetAuditLogFilterRuleOk returns a tuple with the AuditLogFilterRule field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *V1beta1ReplaceAuditLogFilterRuleResponse) GetAuditLogFilterRuleOk() (*Dedicatedv1beta1AuditLogFilterRule, bool) {
	if o == nil || IsNil(o.AuditLogFilterRule) {
		return nil, false
	}
	return o.AuditLogFilterRule, true
}

// HasAuditLogFilterRule returns a boolean if a field has been set.
func (o *V1beta1ReplaceAuditLogFilterRuleResponse) HasAuditLogFilterRule() bool {
	if o != nil && !IsNil(o.AuditLogFilterRule) {
		return true
	}
...
// SetAuditLogFilterRule gets a reference to the given Dedicatedv1beta1AuditLogFilterRule and assigns it to the AuditLogFilterRule field.
func (o *V1beta1ReplaceAuditLogFilterRuleResponse) SetAuditLogFilterRule(v Dedicatedv1beta1AuditLogFilterRule) {
	o.AuditLogFilterRule = &v
}

func (o V1beta1ReplaceAuditLogFilterRuleResponse) MarshalJSON() ([]byte, error) {
...
func (o V1beta1ReplaceAuditLogFilterRuleResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AuditLogFilterRule) {
		toSerialize["auditLogFilterRule"] = o.AuditLogFilterRule
	}
...
func (o *V1beta1ReplaceAuditLogFilterRuleResponse) UnmarshalJSON(data []byte) (err error) {
	varV1beta1ReplaceAuditLogFilterRuleResponse := _V1beta1ReplaceAuditLogFilterRuleResponse{}

	err = json.Unmarshal(data, &varV1beta1ReplaceAuditLogFilterRuleResponse)

	if err != nil {
		return err
	}

	*o = V1beta1ReplaceAuditLogFilterRuleResponse(varV1beta1ReplaceAuditLogFilterRuleResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "auditLogFilterRule")
...
type NullableV1beta1ReplaceAuditLogFilterRuleResponse struct {
	value *V1beta1ReplaceAuditLogFilterRuleResponse
	isSet bool
}

func (v NullableV1beta1ReplaceAuditLogFilterRuleResponse) Get() *V1beta1ReplaceAuditLogFilterRuleResponse {
	return v.value
}

func (v *NullableV1beta1ReplaceAuditLogFilterRuleResponse) Set(val *V1beta1ReplaceAuditLogFilterRuleResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableV1beta1ReplaceAuditLogFilterRuleResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableV1beta1ReplaceAuditLogFilterRuleResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1beta1ReplaceAuditLogFilterRuleResponse(val *V1beta1ReplaceAuditLogFilterRuleResponse) *NullableV1beta1ReplaceAuditLogFilterRuleResponse {
	return &NullableV1beta1ReplaceAuditLogFilterRuleResponse{value: val, isSet: true}
}

func (v NullableV1beta1ReplaceAuditLogFilterRuleResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1beta1ReplaceAuditLogFilterRuleResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
