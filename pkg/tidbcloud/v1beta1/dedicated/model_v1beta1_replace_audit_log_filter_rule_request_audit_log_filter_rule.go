...
// checks if the V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule{}

// V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule struct for V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule
type V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule struct {
	ClusterId            string                                        `json:"clusterId"`
	AuditLogFilterRuleId string                                        `json:"auditLogFilterRuleId"`
...
type _V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule

// NewV1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule instantiates a new V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewV1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule(clusterId string, auditLogFilterRuleId string) *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule {
	this := V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule{}
	this.ClusterId = clusterId
	this.AuditLogFilterRuleId = auditLogFilterRuleId
	return &this
}

// NewV1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRuleWithDefaults instantiates a new V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewV1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRuleWithDefaults() *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule {
	this := V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule{}
	return &this
}

// GetClusterId returns the ClusterId field value
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) GetClusterId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) GetClusterIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) SetClusterId(v string) {
	o.ClusterId = v
}

// GetAuditLogFilterRuleId returns the AuditLogFilterRuleId field value
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) GetAuditLogFilterRuleId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// GetAuditLogFilterRuleIdOk returns a tuple with the AuditLogFilterRuleId field value
// and a boolean to check if the value has been set.
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) GetAuditLogFilterRuleIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// SetAuditLogFilterRuleId sets field value
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) SetAuditLogFilterRuleId(v string) {
	o.AuditLogFilterRuleId = v
}

// GetUserExpr returns the UserExpr field value if set, zero value otherwise.
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) GetUserExpr() string {
...
// and a boolean to check if the value has been set.
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) GetUserExprOk() (*string, bool) {
	if o == nil || IsNil(o.UserExpr) {
		return nil, false
	}
...
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) HasUserExpr() bool {
	if o != nil && !IsNil(o.UserExpr) {
		return true
	}
...
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) SetUserExpr(v string) {
	o.UserExpr = &v
}

// GetDisabled returns the Disabled field value if set, zero value otherwise.
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) GetDisabled() bool {
...
// and a boolean to check if the value has been set.
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) GetDisabledOk() (*bool, bool) {
	if o == nil || IsNil(o.Disabled) {
		return nil, false
	}
...
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) HasDisabled() bool {
	if o != nil && !IsNil(o.Disabled) {
		return true
	}
...
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) SetDisabled(v bool) {
	o.Disabled = &v
}

// GetEventTypes returns the EventTypes field value if set, zero value otherwise.
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) GetEventTypes() []Dedicatedv1beta1AuditLogFilterRuleEventType {
...
// and a boolean to check if the value has been set.
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) GetEventTypesOk() ([]Dedicatedv1beta1AuditLogFilterRuleEventType, bool) {
	if o == nil || IsNil(o.EventTypes) {
		return nil, false
	}
...
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) HasEventTypes() bool {
	if o != nil && !IsNil(o.EventTypes) {
		return true
	}
...
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) SetEventTypes(v []Dedicatedv1beta1AuditLogFilterRuleEventType) {
	o.EventTypes = v
}

// GetDisplayName returns the DisplayName field value if set, zero value otherwise.
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) GetDisplayName() string {
...
// and a boolean to check if the value has been set.
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) GetDisplayNameOk() (*string, bool) {
	if o == nil || IsNil(o.DisplayName) {
		return nil, false
	}
...
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) HasDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
...
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) SetDisplayName(v string) {
	o.DisplayName = &v
}

func (o V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) MarshalJSON() ([]byte, error) {
...
func (o V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) ToMap() (map[string]interface{}, error) {
...
func (o *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) UnmarshalJSON(data []byte) (err error) {
	...
	varV1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule := _V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule{}

	err = json.Unmarshal(data, &varV1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule)

	if err != nil {
		return err
	}

	*o = V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule(varV1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule)
...
type NullableV1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule struct {
	value *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule
	isSet bool
}

func (v NullableV1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) Get() *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule {
	return v.value
}

func (v *NullableV1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) Set(val *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) {
	v.value = val
	v.isSet = true
}

func (v NullableV1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) IsSet() bool {
	return v.isSet
}

func (v *NullableV1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule(val *V1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) *NullableV1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule {
	return &NullableV1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule{value: val, isSet: true}
}

func (v NullableV1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1beta1ReplaceAuditLogFilterRuleRequestAuditLogFilterRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
