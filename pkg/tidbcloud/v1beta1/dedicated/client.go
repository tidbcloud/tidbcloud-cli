...
// APIClient manages communication with the TiDB Cloud Dedicated API API vv1beta1
...
type APIClient struct {
	...
	MaintenanceServiceAPI *MaintenanceServiceAPIService

	NetworkContainerServiceAPI *NetworkContainerServiceAPIService

	PrivateEndpointConnectionServiceAPI *PrivateEndpointConnectionServiceAPIService

	RegionServiceAPI *RegionServiceAPIService

	TidbNodeGroupServiceAPI *TidbNodeGroupServiceAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.MaintenanceServiceAPI = (*MaintenanceServiceAPIService)(&c.common)
	c.NetworkContainerServiceAPI = (*NetworkContainerServiceAPIService)(&c.common)
	c.PrivateEndpointConnectionServiceAPI = (*PrivateEndpointConnectionServiceAPIService)(&c.common)
	c.RegionServiceAPI = (*RegionServiceAPIService)(&c.common)
	c.TidbNodeGroupServiceAPI = (*TidbNodeGroupServiceAPIService)(&c.common)
