...
// Dedicatedv1beta1AuditLogFilterRuleEventType the model 'Dedicatedv1beta1AuditLogFilterRuleEventType'
type Dedicatedv1beta1AuditLogFilterRuleEventType string

// List of dedicatedv1beta1AuditLogFilterRuleEventType
const (
	DEDICATEDV1BETA1AUDITLOGFILTERRULEEVENTTYPE_CONNECTION  Dedicatedv1beta1AuditLogFilterRuleEventType = "CONNECTION"
	DEDICATEDV1BETA1AUDITLOGFILTERRULEEVENTTYPE_CONNECT     Dedicatedv1beta1AuditLogFilterRuleEventType = "CONNECT"
	DEDICATEDV1BETA1AUDITLOGFILTERRULEEVENTTYPE_DISCONNECT  Dedicatedv1beta1AuditLogFilterRuleEventType = "DISCONNECT"
	DEDICATEDV1BETA1AUDITLOGFILTERRULEEVENTTYPE_CHANGE_USER Dedicatedv1beta1AuditLogFilterRuleEventType = "CHANGE_USER"
	DEDICATEDV1BETA1AUDITLOGFILTERRULEEVENTTYPE_QUERY       Dedicatedv1beta1AuditLogFilterRuleEventType = "QUERY"
	DEDICATEDV1BETA1AUDITLOGFILTERRULEEVENTTYPE_TRANSACTION Dedicatedv1beta1AuditLogFilterRuleEventType = "TRANSACTION"
	DEDICATEDV1BETA1AUDITLOGFILTERRULEEVENTTYPE_EXECUTE     Dedicatedv1beta1AuditLogFilterRuleEventType = "EXECUTE"
	DEDICATEDV1BETA1AUDITLOGFILTERRULEEVENTTYPE_QUERY_DML   Dedicatedv1beta1AuditLogFilterRuleEventType = "QUERY_DML"
	DEDICATEDV1BETA1AUDITLOGFILTERRULEEVENTTYPE_INSERT      Dedicatedv1beta1AuditLogFilterRuleEventType = "INSERT"
	DEDICATEDV1BETA1AUDITLOGFILTERRULEEVENTTYPE_REPLACE     Dedicatedv1beta1AuditLogFilterRuleEventType = "REPLACE"
	DEDICATEDV1BETA1AUDITLOGFILTERRULEEVENTTYPE_UPDATE      Dedicatedv1beta1AuditLogFilterRuleEventType = "UPDATE"
	DEDICATEDV1BETA1AUDITLOGFILTERRULEEVENTTYPE_DELETE      Dedicatedv1beta1AuditLogFilterRuleEventType = "DELETE"
	DEDICATEDV1BETA1AUDITLOGFILTERRULEEVENTTYPE_LOAD_DATA   Dedicatedv1beta1AuditLogFilterRuleEventType = "LOAD_DATA"
	DEDICATEDV1BETA1AUDITLOGFILTERRULEEVENTTYPE_SELECT      Dedicatedv1beta1AuditLogFilterRuleEventType = "SELECT"
	DEDICATEDV1BETA1AUDITLOGFILTERRULEEVENTTYPE_QUERY_DDL   Dedicatedv1beta1AuditLogFilterRuleEventType = "QUERY_DDL"
)

// All allowed values of Dedicatedv1beta1AuditLogFilterRuleEventType enum
var AllowedDedicatedv1beta1AuditLogFilterRuleEventTypeEnumValues = []Dedicatedv1beta1AuditLogFilterRuleEventType{
	"CONNECTION",
	"CONNECT",
	"DISCONNECT",
	"CHANGE_USER",
...
func (v *Dedicatedv1beta1AuditLogFilterRuleEventType) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := Dedicatedv1beta1AuditLogFilterRuleEventType(value)
	for _, existing := range AllowedDedicatedv1beta1AuditLogFilterRuleEventTypeEnumValues {
	...
	*v = Dedicatedv1beta1AuditLogFilterRuleEventType(value)
	return nil
}

// NewDedicatedv1beta1AuditLogFilterRuleEventTypeFromValue returns a pointer to a valid Dedicatedv1beta1AuditLogFilterRuleEventType for the value passed as argument
func NewDedicatedv1beta1AuditLogFilterRuleEventTypeFromValue(v string) *Dedicatedv1beta1AuditLogFilterRuleEventType {
	ev := Dedicatedv1beta1AuditLogFilterRuleEventType(v)
	return &ev
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v Dedicatedv1beta1AuditLogFilterRuleEventType) IsValid() bool {
	for _, existing := range AllowedDedicatedv1beta1AuditLogFilterRuleEventTypeEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to dedicatedv1beta1AuditLogFilterRuleEventType value
func (v Dedicatedv1beta1AuditLogFilterRuleEventType) Ptr() *Dedicatedv1beta1AuditLogFilterRuleEventType {
	return &v
}

type NullableDedicatedv1beta1AuditLogFilterRuleEventType struct {
	value *Dedicatedv1beta1AuditLogFilterRuleEventType
	isSet bool
}

func (v NullableDedicatedv1beta1AuditLogFilterRuleEventType) Get() *Dedicatedv1beta1AuditLogFilterRuleEventType {
	return v.value
}

func (v *NullableDedicatedv1beta1AuditLogFilterRuleEventType) Set(val *Dedicatedv1beta1AuditLogFilterRuleEventType) {
	v.value = val
	v.isSet = true
}

func (v NullableDedicatedv1beta1AuditLogFilterRuleEventType) IsSet() bool {
	return v.isSet
}

func (v *NullableDedicatedv1beta1AuditLogFilterRuleEventType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDedicatedv1beta1AuditLogFilterRuleEventType(val *Dedicatedv1beta1AuditLogFilterRuleEventType) *NullableDedicatedv1beta1AuditLogFilterRuleEventType {
	return &NullableDedicatedv1beta1AuditLogFilterRuleEventType{value: val, isSet: true}
}

func (v NullableDedicatedv1beta1AuditLogFilterRuleEventType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDedicatedv1beta1AuditLogFilterRuleEventType) UnmarshalJSON(src []byte) error {
	v.isSet = true
