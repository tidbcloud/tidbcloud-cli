...
func (v *V1beta1MaintenanceTaskState) UnmarshalJSON(src []byte) error {
	...
	*v = V1beta1MaintenanceTaskState(value)
	return nil
}

// NewV1beta1MaintenanceTaskStateFromValue returns a pointer to a valid V1beta1MaintenanceTaskState for the value passed as argument
