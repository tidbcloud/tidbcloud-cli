...
// checks if the RequiredTheAuditLogFilterRuleToUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequiredTheAuditLogFilterRuleToUpdate{}

// RequiredTheAuditLogFilterRuleToUpdate struct for RequiredTheAuditLogFilterRuleToUpdate
type RequiredTheAuditLogFilterRuleToUpdate struct {
...
type _RequiredTheAuditLogFilterRuleToUpdate RequiredTheAuditLogFilterRuleToUpdate

// NewRequiredTheAuditLogFilterRuleToUpdate instantiates a new RequiredTheAuditLogFilterRuleToUpdate object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRequiredTheAuditLogFilterRuleToUpdate() *RequiredTheAuditLogFilterRuleToUpdate {
	this := RequiredTheAuditLogFilterRuleToUpdate{}
	return &this
}

// NewRequiredTheAuditLogFilterRuleToUpdateWithDefaults instantiates a new RequiredTheAuditLogFilterRuleToUpdate object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRequiredTheAuditLogFilterRuleToUpdateWithDefaults() *RequiredTheAuditLogFilterRuleToUpdate {
	this := RequiredTheAuditLogFilterRuleToUpdate{}
	return &this
}

// GetUserExpr returns the UserExpr field value if set, zero value otherwise.
func (o *RequiredTheAuditLogFilterRuleToUpdate) GetUserExpr() string {
...
func (o *RequiredTheAuditLogFilterRuleToUpdate) GetUserExprOk() (*string, bool) {
	if o == nil || IsNil(o.UserExpr) {
		return nil, false
	}
...
func (o *RequiredTheAuditLogFilterRuleToUpdate) HasUserExpr() bool {
	if o != nil && !IsNil(o.UserExpr) {
		return true
	}
...
func (o *RequiredTheAuditLogFilterRuleToUpdate) SetUserExpr(v string) {
	o.UserExpr = &v
}

// GetDisabled returns the Disabled field value if set, zero value otherwise.
func (o *RequiredTheAuditLogFilterRuleToUpdate) GetDisabled() bool {
...
// and a boolean to check if the value has been set.
func (o *RequiredTheAuditLogFilterRuleToUpdate) GetDisabledOk() (*bool, bool) {
	if o == nil || IsNil(o.Disabled) {
		return nil, false
	}
...
func (o *RequiredTheAuditLogFilterRuleToUpdate) HasDisabled() bool {
	if o != nil && !IsNil(o.Disabled) {
		return true
	}
...
func (o *RequiredTheAuditLogFilterRuleToUpdate) SetDisabled(v bool) {
	o.Disabled = &v
}

// GetEventTypes returns the EventTypes field value if set, zero value otherwise.
func (o *RequiredTheAuditLogFilterRuleToUpdate) GetEventTypes() []Dedicatedv1beta1AuditLogFilterRuleEventType {
...
// and a boolean to check if the value has been set.
func (o *RequiredTheAuditLogFilterRuleToUpdate) GetEventTypesOk() ([]Dedicatedv1beta1AuditLogFilterRuleEventType, bool) {
	if o == nil || IsNil(o.EventTypes) {
		return nil, false
	}
...
func (o *RequiredTheAuditLogFilterRuleToUpdate) HasEventTypes() bool {
	if o != nil && !IsNil(o.EventTypes) {
		return true
	}
...
func (o *RequiredTheAuditLogFilterRuleToUpdate) SetEventTypes(v []Dedicatedv1beta1AuditLogFilterRuleEventType) {
	o.EventTypes = v
}

// GetDisplayName returns the DisplayName field value if set, zero value otherwise.
func (o *RequiredTheAuditLogFilterRuleToUpdate) GetDisplayName() string {
...
// and a boolean to check if the value has been set.
func (o *RequiredTheAuditLogFilterRuleToUpdate) GetDisplayNameOk() (*string, bool) {
	if o == nil || IsNil(o.DisplayName) {
		return nil, false
	}
...
func (o *RequiredTheAuditLogFilterRuleToUpdate) HasDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
...
func (o *RequiredTheAuditLogFilterRuleToUpdate) SetDisplayName(v string) {
	o.DisplayName = &v
}

func (o RequiredTheAuditLogFilterRuleToUpdate) MarshalJSON() ([]byte, error) {
...
func (o RequiredTheAuditLogFilterRuleToUpdate) ToMap() (map[string]interface{}, error) {
...
func (o *RequiredTheAuditLogFilterRuleToUpdate) UnmarshalJSON(data []byte) (err error) {
	varRequiredTheAuditLogFilterRuleToUpdate := _RequiredTheAuditLogFilterRuleToUpdate{}

	err = json.Unmarshal(data, &varRequiredTheAuditLogFilterRuleToUpdate)

	if err != nil {
		return err
	}

	*o = RequiredTheAuditLogFilterRuleToUpdate(varRequiredTheAuditLogFilterRuleToUpdate)
...
type NullableRequiredTheAuditLogFilterRuleToUpdate struct {
	value *RequiredTheAuditLogFilterRuleToUpdate
	isSet bool
}

func (v NullableRequiredTheAuditLogFilterRuleToUpdate) Get() *RequiredTheAuditLogFilterRuleToUpdate {
	return v.value
}

func (v *NullableRequiredTheAuditLogFilterRuleToUpdate) Set(val *RequiredTheAuditLogFilterRuleToUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableRequiredTheAuditLogFilterRuleToUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableRequiredTheAuditLogFilterRuleToUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequiredTheAuditLogFilterRuleToUpdate(val *RequiredTheAuditLogFilterRuleToUpdate) *NullableRequiredTheAuditLogFilterRuleToUpdate {
	return &NullableRequiredTheAuditLogFilterRuleToUpdate{value: val, isSet: true}
}

func (v NullableRequiredTheAuditLogFilterRuleToUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequiredTheAuditLogFilterRuleToUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
