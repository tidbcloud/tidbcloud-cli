...
type UpdateClusterRequestTidbNodeSettingTidbNodeGroup struct {
	// The ID of the TiDB node group. If empty, it means to scale the default TiDB group.
	...
	// The TiProxy setting for the TiDB group. If not specified, the default TiProxy setting will be used.
...
func (o *UpdateClusterRequestTidbNodeSettingTidbNodeGroup) GetTiproxySetting() Dedicatedv1beta1TidbNodeGroupTiProxySetting {
...
// and a boolean to check if the value has been set.
func (o *UpdateClusterRequestTidbNodeSettingTidbNodeGroup) GetTiproxySettingOk() (*Dedicatedv1beta1TidbNodeGroupTiProxySetting, bool) {
	if o == nil || IsNil(o.TiproxySetting) {
		return nil, false
	}
...
func (o *UpdateClusterRequestTidbNodeSettingTidbNodeGroup) HasTiproxySetting() bool {
	if o != nil && !IsNil(o.TiproxySetting) {
		return true
	}
...
func (o *UpdateClusterRequestTidbNodeSettingTidbNodeGroup) SetTiproxySetting(v Dedicatedv1beta1TidbNodeGroupTiProxySetting) {
	o.TiproxySetting = &v
}

// GetNodeSpecKey returns the NodeSpecKey field value if set, zero value otherwise.
func (o *UpdateClusterRequestTidbNodeSettingTidbNodeGroup) GetNodeSpecKey() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateClusterRequestTidbNodeSettingTidbNodeGroup) GetNodeSpecKeyOk() (*string, bool) {
	if o == nil || IsNil(o.NodeSpecKey) {
		return nil, false
	}
...
func (o *UpdateClusterRequestTidbNodeSettingTidbNodeGroup) HasNodeSpecKey() bool {
	if o != nil && !IsNil(o.NodeSpecKey) {
		return true
	}
...
func (o *UpdateClusterRequestTidbNodeSettingTidbNodeGroup) SetNodeSpecKey(v string) {
	o.NodeSpecKey = &v
}
