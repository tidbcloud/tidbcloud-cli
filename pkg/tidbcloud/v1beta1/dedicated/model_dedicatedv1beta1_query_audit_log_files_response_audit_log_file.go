...
// checks if the Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile{}

// Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile struct for Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile
type Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile struct {
...
type _Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile

// NewDedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile instantiates a new Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile() *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile {
	this := Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile{}
	return &this
}

// NewDedicatedv1beta1QueryAuditLogFilesResponseAuditLogFileWithDefaults instantiates a new Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDedicatedv1beta1QueryAuditLogFilesResponseAuditLogFileWithDefaults() *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile {
	this := Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile{}
	return &this
}

// GetFilename returns the Filename field value if set, zero value otherwise.
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) GetFilename() string {
...
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) GetFilenameOk() (*string, bool) {
	if o == nil || IsNil(o.Filename) {
		return nil, false
	}
...
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) HasFilename() bool {
	if o != nil && !IsNil(o.Filename) {
		return true
	}
...
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) SetFilename(v string) {
	o.Filename = &v
}

// GetUri returns the Uri field value if set, zero value otherwise.
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) GetUri() string {
...
// and a boolean to check if the value has been set.
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) GetUriOk() (*string, bool) {
	if o == nil || IsNil(o.Uri) {
		return nil, false
	}
	return o.Uri, true
...
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) HasUri() bool {
	if o != nil && !IsNil(o.Uri) {
		return true
	}
...
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) SetUri(v string) {
	o.Uri = &v
}

// GetBucket returns the Bucket field value if set, zero value otherwise.
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) GetBucket() string {
...
// and a boolean to check if the value has been set.
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) GetBucketOk() (*string, bool) {
	if o == nil || IsNil(o.Bucket) {
		return nil, false
	}
...
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) HasBucket() bool {
	if o != nil && !IsNil(o.Bucket) {
		return true
	}
...
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) SetBucket(v string) {
	o.Bucket = &v
}

// GetSizeByte returns the SizeByte field value if set, zero value otherwise.
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) GetSizeByte() int32 {
...
// and a boolean to check if the value has been set.
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) GetSizeByteOk() (*int32, bool) {
	if o == nil || IsNil(o.SizeByte) {
		return nil, false
	}
...
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) HasSizeByte() bool {
	if o != nil && !IsNil(o.SizeByte) {
		return true
	}
...
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) SetSizeByte(v int32) {
	o.SizeByte = &v
}

// GetCreateTime returns the CreateTime field value if set, zero value otherwise.
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) GetCreateTime() time.Time {
...
// and a boolean to check if the value has been set.
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) GetCreateTimeOk() (*time.Time, bool) {
	if o == nil || IsNil(o.CreateTime) {
		return nil, false
	}
...
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) HasCreateTime() bool {
	if o != nil && !IsNil(o.CreateTime) {
		return true
	}
...
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) SetCreateTime(v time.Time) {
	o.CreateTime = &v
}

func (o Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) MarshalJSON() ([]byte, error) {
...
func (o Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) ToMap() (map[string]interface{}, error) {
...
func (o *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) UnmarshalJSON(data []byte) (err error) {
	varDedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile := _Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile{}

	err = json.Unmarshal(data, &varDedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile)

	if err != nil {
		return err
	}

	*o = Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile(varDedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile)
...
type NullableDedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile struct {
	value *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile
	isSet bool
}

func (v NullableDedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) Get() *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile {
	return v.value
}

func (v *NullableDedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) Set(val *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) {
	v.value = val
	v.isSet = true
}

func (v NullableDedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) IsSet() bool {
	return v.isSet
}

func (v *NullableDedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile(val *Dedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) *NullableDedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile {
	return &NullableDedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile{value: val, isSet: true}
}

func (v NullableDedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDedicatedv1beta1QueryAuditLogFilesResponseAuditLogFile) UnmarshalJSON(src []byte) error {
	v.isSet = true
