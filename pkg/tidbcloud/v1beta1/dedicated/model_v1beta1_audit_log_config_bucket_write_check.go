...
// checks if the V1beta1AuditLogConfigBucketWriteCheck type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1beta1AuditLogConfigBucketWriteCheck{}

// V1beta1AuditLogConfigBucketWriteCheck struct for V1beta1AuditLogConfigBucketWriteCheck
type V1beta1AuditLogConfigBucketWriteCheck struct {
...
type _V1beta1AuditLogConfigBucketWriteCheck V1beta1AuditLogConfigBucketWriteCheck

// NewV1beta1AuditLogConfigBucketWriteCheck instantiates a new V1beta1AuditLogConfigBucketWriteCheck object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewV1beta1AuditLogConfigBucketWriteCheck() *V1beta1AuditLogConfigBucketWriteCheck {
	this := V1beta1AuditLogConfigBucketWriteCheck{}
	return &this
}

// NewV1beta1AuditLogConfigBucketWriteCheckWithDefaults instantiates a new V1beta1AuditLogConfigBucketWriteCheck object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewV1beta1AuditLogConfigBucketWriteCheckWithDefaults() *V1beta1AuditLogConfigBucketWriteCheck {
	this := V1beta1AuditLogConfigBucketWriteCheck{}
	return &this
}

// GetWritable returns the Writable field value if set, zero value otherwise.
func (o *V1beta1AuditLogConfigBucketWriteCheck) GetWritable() bool {
...
func (o *V1beta1AuditLogConfigBucketWriteCheck) GetWritableOk() (*bool, bool) {
	if o == nil || IsNil(o.Writable) {
		return nil, false
	}
...
func (o *V1beta1AuditLogConfigBucketWriteCheck) HasWritable() bool {
	if o != nil && !IsNil(o.Writable) {
		return true
	}
...
func (o *V1beta1AuditLogConfigBucketWriteCheck) SetWritable(v bool) {
	o.Writable = &v
}

// GetErrorReason returns the ErrorReason field value if set, zero value otherwise.
func (o *V1beta1AuditLogConfigBucketWriteCheck) GetErrorReason() string {
...
// and a boolean to check if the value has been set.
func (o *V1beta1AuditLogConfigBucketWriteCheck) GetErrorReasonOk() (*string, bool) {
	if o == nil || IsNil(o.ErrorReason) {
		return nil, false
	}
...
func (o *V1beta1AuditLogConfigBucketWriteCheck) HasErrorReason() bool {
	if o != nil && !IsNil(o.ErrorReason) {
		return true
	}
...
func (o *V1beta1AuditLogConfigBucketWriteCheck) SetErrorReason(v string) {
	o.ErrorReason = &v
}

func (o V1beta1AuditLogConfigBucketWriteCheck) MarshalJSON() ([]byte, error) {
...
func (o V1beta1AuditLogConfigBucketWriteCheck) ToMap() (map[string]interface{}, error) {
...
func (o *V1beta1AuditLogConfigBucketWriteCheck) UnmarshalJSON(data []byte) (err error) {
	varV1beta1AuditLogConfigBucketWriteCheck := _V1beta1AuditLogConfigBucketWriteCheck{}

	err = json.Unmarshal(data, &varV1beta1AuditLogConfigBucketWriteCheck)

	if err != nil {
		return err
	}

	*o = V1beta1AuditLogConfigBucketWriteCheck(varV1beta1AuditLogConfigBucketWriteCheck)
...
type NullableV1beta1AuditLogConfigBucketWriteCheck struct {
	value *V1beta1AuditLogConfigBucketWriteCheck
	isSet bool
}

func (v NullableV1beta1AuditLogConfigBucketWriteCheck) Get() *V1beta1AuditLogConfigBucketWriteCheck {
	return v.value
}

func (v *NullableV1beta1AuditLogConfigBucketWriteCheck) Set(val *V1beta1AuditLogConfigBucketWriteCheck) {
	v.value = val
	v.isSet = true
}

func (v NullableV1beta1AuditLogConfigBucketWriteCheck) IsSet() bool {
	return v.isSet
}

func (v *NullableV1beta1AuditLogConfigBucketWriteCheck) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1beta1AuditLogConfigBucketWriteCheck(val *V1beta1AuditLogConfigBucketWriteCheck) *NullableV1beta1AuditLogConfigBucketWriteCheck {
	return &NullableV1beta1AuditLogConfigBucketWriteCheck{value: val, isSet: true}
}

func (v NullableV1beta1AuditLogConfigBucketWriteCheck) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1beta1AuditLogConfigBucketWriteCheck) UnmarshalJSON(src []byte) error {
	v.isSet = true
