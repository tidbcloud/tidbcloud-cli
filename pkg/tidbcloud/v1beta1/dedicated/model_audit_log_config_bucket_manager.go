...
// AuditLogConfigBucketManager the model 'AuditLogConfigBucketManager'
type AuditLogConfigBucketManager string

// List of AuditLogConfigBucketManager
const (
	AUDITLOGCONFIGBUCKETMANAGER_CUSTOMER AuditLogConfigBucketManager = "CUSTOMER"
	AUDITLOGCONFIGBUCKETMANAGER_PINGCAP  AuditLogConfigBucketManager = "PINGCAP"
)

// All allowed values of AuditLogConfigBucketManager enum
var AllowedAuditLogConfigBucketManagerEnumValues = []AuditLogConfigBucketManager{
	"CUSTOMER",
	"PINGCAP",
}

func (v *AuditLogConfigBucketManager) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := AuditLogConfigBucketManager(value)
	for _, existing := range AllowedAuditLogConfigBucketManagerEnumValues {
	...
	*v = AuditLogConfigBucketManager(value)
	return nil
}

// NewAuditLogConfigBucketManagerFromValue returns a pointer to a valid AuditLogConfigBucketManager for the value passed as argument
func NewAuditLogConfigBucketManagerFromValue(v string) *AuditLogConfigBucketManager {
	ev := AuditLogConfigBucketManager(v)
	return &ev
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v AuditLogConfigBucketManager) IsValid() bool {
	for _, existing := range AllowedAuditLogConfigBucketManagerEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to AuditLogConfigBucketManager value
func (v AuditLogConfigBucketManager) Ptr() *AuditLogConfigBucketManager {
	return &v
}

type NullableAuditLogConfigBucketManager struct {
	value *AuditLogConfigBucketManager
	isSet bool
}

func (v NullableAuditLogConfigBucketManager) Get() *AuditLogConfigBucketManager {
	return v.value
}

func (v *NullableAuditLogConfigBucketManager) Set(val *AuditLogConfigBucketManager) {
	v.value = val
	v.isSet = true
}

func (v NullableAuditLogConfigBucketManager) IsSet() bool {
	return v.isSet
}

func (v *NullableAuditLogConfigBucketManager) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuditLogConfigBucketManager(val *AuditLogConfigBucketManager) *NullableAuditLogConfigBucketManager {
	return &NullableAuditLogConfigBucketManager{value: val, isSet: true}
}

func (v NullableAuditLogConfigBucketManager) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuditLogConfigBucketManager) UnmarshalJSON(src []byte) error {
	v.isSet = true
