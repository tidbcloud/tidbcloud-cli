...
// checks if the Dedicatedv1beta1ListAuditLogFilterRulesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Dedicatedv1beta1ListAuditLogFilterRulesResponse{}

// Dedicatedv1beta1ListAuditLogFilterRulesResponse struct for Dedicatedv1beta1ListAuditLogFilterRulesResponse
type Dedicatedv1beta1ListAuditLogFilterRulesResponse struct {
	AuditLogFilterRules  []Dedicatedv1beta1AuditLogFilterRule `json:"auditLogFilterRules,omitempty"`
	TotalSize            *int32                               `json:"totalSize,omitempty"`
	NextPageToken        *string                              `json:"nextPageToken,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _Dedicatedv1beta1ListAuditLogFilterRulesResponse Dedicatedv1beta1ListAuditLogFilterRulesResponse

// NewDedicatedv1beta1ListAuditLogFilterRulesResponse instantiates a new Dedicatedv1beta1ListAuditLogFilterRulesResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDedicatedv1beta1ListAuditLogFilterRulesResponse() *Dedicatedv1beta1ListAuditLogFilterRulesResponse {
	this := Dedicatedv1beta1ListAuditLogFilterRulesResponse{}
	return &this
}

// NewDedicatedv1beta1ListAuditLogFilterRulesResponseWithDefaults instantiates a new Dedicatedv1beta1ListAuditLogFilterRulesResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDedicatedv1beta1ListAuditLogFilterRulesResponseWithDefaults() *Dedicatedv1beta1ListAuditLogFilterRulesResponse {
	this := Dedicatedv1beta1ListAuditLogFilterRulesResponse{}
	return &this
}

// GetAuditLogFilterRules returns the AuditLogFilterRules field value if set, zero value otherwise.
func (o *Dedicatedv1beta1ListAuditLogFilterRulesResponse) GetAuditLogFilterRules() []Dedicatedv1beta1AuditLogFilterRule {
	if o == nil || IsNil(o.AuditLogFilterRules) {
		var ret []Dedicatedv1beta1AuditLogFilterRule
		return ret
	}
...
func (o *Dedicatedv1beta1ListAuditLogFilterRulesResponse) GetAuditLogFilterRulesOk() ([]Dedicatedv1beta1AuditLogFilterRule, bool) {
	if o == nil || IsNil(o.AuditLogFilterRules) {
		return nil, false
	}
...
func (o *Dedicatedv1beta1ListAuditLogFilterRulesResponse) HasAuditLogFilterRules() bool {
	if o != nil && !IsNil(o.AuditLogFilterRules) {
		return true
	}
...
// SetAuditLogFilterRules gets a reference to the given []Dedicatedv1beta1AuditLogFilterRule and assigns it to the AuditLogFilterRules field.
func (o *Dedicatedv1beta1ListAuditLogFilterRulesResponse) SetAuditLogFilterRules(v []Dedicatedv1beta1AuditLogFilterRule) {
	o.AuditLogFilterRules = v
}

// GetTotalSize returns the TotalSize field value if set, zero value otherwise.
func (o *Dedicatedv1beta1ListAuditLogFilterRulesResponse) GetTotalSize() int32 {
...
// and a boolean to check if the value has been set.
func (o *Dedicatedv1beta1ListAuditLogFilterRulesResponse) GetTotalSizeOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalSize) {
		return nil, false
	}
...
func (o *Dedicatedv1beta1ListAuditLogFilterRulesResponse) HasTotalSize() bool {
	if o != nil && !IsNil(o.TotalSize) {
		return true
	}
...
func (o *Dedicatedv1beta1ListAuditLogFilterRulesResponse) SetTotalSize(v int32) {
	o.TotalSize = &v
}

// GetNextPageToken returns the NextPageToken field value if set, zero value otherwise.
func (o *Dedicatedv1beta1ListAuditLogFilterRulesResponse) GetNextPageToken() string {
...
// and a boolean to check if the value has been set.
func (o *Dedicatedv1beta1ListAuditLogFilterRulesResponse) GetNextPageTokenOk() (*string, bool) {
	if o == nil || IsNil(o.NextPageToken) {
		return nil, false
	}
...
func (o *Dedicatedv1beta1ListAuditLogFilterRulesResponse) HasNextPageToken() bool {
	if o != nil && !IsNil(o.NextPageToken) {
		return true
	}
...
func (o *Dedicatedv1beta1ListAuditLogFilterRulesResponse) SetNextPageToken(v string) {
	o.NextPageToken = &v
}

func (o Dedicatedv1beta1ListAuditLogFilterRulesResponse) MarshalJSON() ([]byte, error) {
...
func (o Dedicatedv1beta1ListAuditLogFilterRulesResponse) ToMap() (map[string]interface{}, error) {
...
func (o *Dedicatedv1beta1ListAuditLogFilterRulesResponse) UnmarshalJSON(data []byte) (err error) {
	varDedicatedv1beta1ListAuditLogFilterRulesResponse := _Dedicatedv1beta1ListAuditLogFilterRulesResponse{}

	err = json.Unmarshal(data, &varDedicatedv1beta1ListAuditLogFilterRulesResponse)

	if err != nil {
		return err
	}

	*o = Dedicatedv1beta1ListAuditLogFilterRulesResponse(varDedicatedv1beta1ListAuditLogFilterRulesResponse)
...
type NullableDedicatedv1beta1ListAuditLogFilterRulesResponse struct {
	value *Dedicatedv1beta1ListAuditLogFilterRulesResponse
	isSet bool
}

func (v NullableDedicatedv1beta1ListAuditLogFilterRulesResponse) Get() *Dedicatedv1beta1ListAuditLogFilterRulesResponse {
	return v.value
}

func (v *NullableDedicatedv1beta1ListAuditLogFilterRulesResponse) Set(val *Dedicatedv1beta1ListAuditLogFilterRulesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDedicatedv1beta1ListAuditLogFilterRulesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDedicatedv1beta1ListAuditLogFilterRulesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDedicatedv1beta1ListAuditLogFilterRulesResponse(val *Dedicatedv1beta1ListAuditLogFilterRulesResponse) *NullableDedicatedv1beta1ListAuditLogFilterRulesResponse {
	return &NullableDedicatedv1beta1ListAuditLogFilterRulesResponse{value: val, isSet: true}
}

func (v NullableDedicatedv1beta1ListAuditLogFilterRulesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDedicatedv1beta1ListAuditLogFilterRulesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
