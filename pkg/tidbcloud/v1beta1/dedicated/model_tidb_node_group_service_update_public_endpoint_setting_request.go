...
type TidbNodeGroupServiceUpdatePublicEndpointSettingRequest struct {
	// The name of the public endpoint setting resource formatted as: `tidbNodeGroups/{tidb_node_group_id}/publicEndpointSetting`.
	Name *string `json:"name,omitempty"`
	// Indicates whether the public endpoint is enabled for the TiDB group.
	Enabled NullableBool `json:"enabled,omitempty"`
	// A list of IP access control lists for the public endpoint. If not set, all IPs are allowed to access the public endpoint.
