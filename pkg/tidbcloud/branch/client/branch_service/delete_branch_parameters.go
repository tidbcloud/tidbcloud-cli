...
// WithClusterID adds the clusterID to the delete branch params
func (o *DeleteBranchParams) WithClusterID(clusterID string) *DeleteBranchParams {
	o.SetClusterID(clusterID)
	return o
}

// SetClusterID adds the clusterId to the delete branch params
func (o *DeleteBranchParams) SetClusterID(clusterID string) {
