...
// OpenapiDPImportCreateReq1 openapi d p import create req1
//
// swagger:model openapiDPImportCreateReq1
type OpenapiDPImportCreateReq1 struct {
...
// Validate validates this openapi d p import create req1
func (m *OpenapiDPImportCreateReq1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenapiDPImportCreateReq1) validateClusterID(formats strfmt.Registry) error {
...
func (m *OpenapiDPImportCreateReq1) validateCsvFormat(formats strfmt.Registry) error {
...
func (m *OpenapiDPImportCreateReq1) validateDataFormat(formats strfmt.Registry) error {
...
func (m *OpenapiDPImportCreateReq1) validateDataSourceType(formats strfmt.Registry) error {
...
func (m *OpenapiDPImportCreateReq1) validateFilter(formats strfmt.Registry) error {
...
func (m *OpenapiDPImportCreateReq1) validateOrgID(formats strfmt.Registry) error {
...
func (m *OpenapiDPImportCreateReq1) validateProjectID(formats strfmt.Registry) error {
...
func (m *OpenapiDPImportCreateReq1) validateRegion(formats strfmt.Registry) error {
...
func (m *OpenapiDPImportCreateReq1) validateSourceURL(formats strfmt.Registry) error {
...
func (m *OpenapiDPImportCreateReq1) validateTargetPassword(formats strfmt.Registry) error {
...
func (m *OpenapiDPImportCreateReq1) validateTargetUsername(formats strfmt.Registry) error {
...
// ContextValidate validate this openapi d p import create req1 based on the context it is used
func (m *OpenapiDPImportCreateReq1) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenapiDPImportCreateReq1) contextValidateCsvFormat(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenapiDPImportCreateReq1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OpenapiDPImportCreateReq1) UnmarshalBinary(b []byte) error {
	var res OpenapiDPImportCreateReq1
